...
class TransportCancelNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject($this->title)
        ->view('emails.transport.cancel_notification', [
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'receiver' => $this->receiver,
            'comment' => $this->comment,
            'notification'=> "The transport requisition, {$this->transport->travel->procurement->title}, has been canceled"
        ];
    }
}
