...
class ProcurementDelegateNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject($this->title)
        ->view('emails.procurement.delegate_notification', [
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'receiver' => $this->receiver,
            'comment' => $this->comment,
            'notification' => sprintf("You have a delegated procurement requisition (%s) to attend to from %s",
