...
class TransportPdfController extends Controller
{
    public function downloadTransportPdf($id){
        ...
        $pdf = Pdf::loadView('pdf.transport-approval-document', compact(
            'requisition',
            'travel',
            'transport',
            'subsistence',
       ...
       // return $pdf->download();
        return $pdf->stream("transport-approval-document" . time() . ".pdf");
    }
}
