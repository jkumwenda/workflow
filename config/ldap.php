            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '41.70.22.4')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'ou=People,dc=medcol,dc=mw'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'cn=Manager,dc=medcol,dc=mw'),
                'password' => env('LDAP_PASSWORD', 'manager'),
