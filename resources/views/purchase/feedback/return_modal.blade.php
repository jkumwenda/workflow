...
<div class="modal fade" id="confirm_purchase_return" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'POST', 'route' => ['purchase/return', $purchase->id], 'autocomplete' => 'off']) !!}
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                @endif                                <span class="destination"> {{ $previous['flow']->role->description }} ({{ $previous['flow']->requisitionStatus->name}})</span><br/><br/>
                            </div>
                        </div>
                    </fieldset>
