...
<div class="float-right">
    <a href="{{ route('grades.edit', $grade->id) }}" class="btn btn-primary"> <i class="fa fa-edit"></i> Edit</a>
    <a class="btn btn-danger" href="javascript:void(0);" data-item="{{ route('grades.destroy', $grade->id) }}" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i> Delete</a>
</div>
@endsection
...
<a href="{{ route('grades.index') }}" class="btn btn-outline-dark"><i class="fa fa-backward"></i> Back</a>
@endsection
