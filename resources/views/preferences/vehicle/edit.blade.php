...
<div class="row">
    ...
    {!! Form::model($vehicle, ['method' => 'PATCH', 'route' => ['vehicles.update', $vehicle->id], 'autocomplete' => 'off']) !!}
    <div class="card">
                <div class="card-header card-header-primary">

                    <h4 class="card-title">Update Vehicle info</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                {!! Form::label('vehicle_type_id', 'VehicleType') !!}
                                {!! Form::select('vehicle_type_id',$vehicleTypes,null, ['class' => 'form-control','required' => 'required','placeholder' => '-- Please Select --']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('unit_id',$units,null, ['class' => 'form-control','required' => 'required','placeholder' => '-- Please Select --']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <span id="flow-summary-popover"></span>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                {!! Form::select('make_id',$makes,null, ['class' => 'form-control','required' => 'required','placeholder' => '-- Please Select --']) !!}
                ...
                <div class="card-footer">
                    <!-- Cancel -->
                    <a href="{{ route('vehicles.index') }}" class="btn btn-outline-dark"><i class="fa fa-backward"></i> Cancel</a>
                    <!-- Submit -->
