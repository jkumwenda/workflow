...
@section('title', 'Travel Requisition Supporting Documents')
    ...
    <div class="col-md-10 m-auto" style="padding-bottom: 15px;">
        ...
        <div class="card bg-light mb-5">
            <div class="card-header">
                <h3>{{ idFormatter('travel', $requisition->id) }} - [{{ $requisition->unit->name }}]</h3>
                <h3>{{ $requisition->title }} - Supporting documents</h3>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        <div>
            <a href="{{ route('travel/show', $travel->id) }}" class="btn btn-warning text-white"><i class="fa fa-check"></i> Finish </a>
        </div>
