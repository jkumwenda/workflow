            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row {{ $errors->has('description') ? 'has-danger' :'' }}">
                        ...
                        <div class="col-md-10">
                            {!! Form::textarea('purpose', null, ['class' => 'form-control','required' => 'required', 'autofocus' => true]) !!}
                            @error('purpose')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row {{ $errors->has('title') ? 'has-danger' :'' }}">
                        ...
                        <div class="col-md-4">
                            {!! Form::date('departureDate', null, ['class' => 'form-control datepicker','required' => 'required', 'autofocus' => true, 'id'=>"departureDate"]) !!}
                            @error('departureDate')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-4">
                            {!! Form::date('returnDate', null, ['class' => 'form-control','required' => 'required', 'autofocus' => true, 'id'=>"returnDate"]) !!}
                            @error('returnDate')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row {{ $errors->has('title') ? 'has-danger' :'' }}">
                        ...
                        <div class="col-md-4">
                            {!! Form::select('origin', $campuses, null, ['class' => 'form-control select2', 'required' => 'required','placeholder' => '- Please Select - ']) !!}
                            @error('origin')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-4">
                            {!! Form::select('destination', $districts, null, ['class' => 'form-control select2', 'required' => 'required','placeholder' => '- Please Select - ']) !!}
                            @error('destination')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row {{ $errors->has('title') ? 'has-danger' :'' }}">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="radioButton3" value="option3">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2" name="vehicle">
                                ...
                                @foreach($unitVehicles as $unitVehicle)
                                    <option value="{{$unitVehicle->id}}"> {{$unitVehicle->registration_number}} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-none" id="unitField2">
                        ...
                        <div class="col-md-4">
                            {!! Form::select('vehicleType', $poolVehicles,null,['class' => 'form-control','required' => 'required', 'placeholder' => '--Please Select--']) !!}
                        </div>
                    </div>
                    ...
                    <table class="table table-striped" id="edit_procurement_items">
                        ...
                        <tr class="even pointer">
                            <td class="form-group">
                                {!! Form::select('users[]', $users, null, ['class' => 'form-control <!--select2-->', 'required' => 'required','placeholder' => '- Please Select - ']) !!}
                            </td>
                            <td class="form-group">
                                {!! Form::date('userDepartureDate[]', null, ['class' => 'form-control','required' => 'required', 'autofocus' => true, 'id'=>"userDepartureDate"]) !!}
                            </td>
                            <td class="form-group">
                                {!! Form::date('userReturnDate[]', null, ['class' => 'form-control','required' => 'required', 'autofocus' => true, 'id'=>"userReturnDate"]) !!}
                            </td>
                            <td class="form-group">
                                {!! Form::select('accommodationProvided[]', $accommodationProvided, null, ['class' => 'form-control', 'required' => 'required','placeholder' => '- Please Select - ']) !!}
                            </td>
                        </tr>
                        </tbody>
                    </table>
