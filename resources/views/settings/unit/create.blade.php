...
$(function() {
    ...
    {{-- (/* there are same function in edit.blade.php */) --}}
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                {!! Form::select('company_id',$companies,null, ['class' => 'form-control','required' => 'required','placeholder' => '-- Please Select --']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                {!! Form::select('category',['PROJECT' => 'PROJECT', 'MAIN' => 'MAIN'],null, ['class' => 'form-control','required' => 'required','placeholder' => '-- Please Select --']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
